    ...
    '<div class="app-shell">',
      '<aside class="sidebar">',
        ...
        '<nav class="nav">',
          ...
          navButton('dashboard', 'Accueil', 'AC'),
          navButton('guide', 'Guide CID', 'GD'),
          '<div class="nav-group"><span>CID</span></div>',
          navButton('dossiers', 'Dossiers', 'DS'),
          navButton('personnes', 'Personnes', 'P'),
          navButton('preuves', 'Preuves', 'PR'),
          navButton('gestion', 'Gestion', 'MG'),
          '<div class="nav-group"><span>Historique</span></div>',
          navButton('archives', 'Archives', 'AR'),
        '</nav>',
      '</aside>',
      '<main class="main">',
        '<header class="topbar">',
